/**
 * Board geometry builders — flat plane (legacy) and sphere projection.
 *
 * buildBoardGeometry()  — flat PlaneGeometry with cosine curvature hack (legacy)
 ...
 *
 * Vertex attributes (same interface as buildBoardGeometry):
