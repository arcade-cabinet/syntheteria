...
| [memory-bank/systemPatterns.md](memory-bank/systemPatterns.md) | ECS patterns, resource/building patterns, radial menu, render patterns |
...
| Resource/building/radial patterns | `memory-bank/systemPatterns.md` |
