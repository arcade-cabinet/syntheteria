...
const SLOT_LAYOUTS: Record<WorldPoiType, ConstructionSlot[]> = {
	home_base: [
		...
		{ index: 2, offset: { x: -6, z: 0 }, tier: 0, unlockRequirements: [] },
		{
			...
			offset: { x: 0, z: 6 },
			tier: 1,
			unlockRequirements: ["relay"],
		},
		{
			index: 4,
			offset: { x: 0, z: -6 },
			tier: 1,
			unlockRequirements: ["power_sink"],
		},
		{
			index: 5,
			offset: { x: 6, z: 6 },
			tier: 2,
			unlockRequirements: ["relay", "fabrication"],
		},
		{
			index: 6,
			offset: { x: -6, z: 6 },
			tier: 2,
			unlockRequirements: ["transit", "relay"],
		},
		{
			index: 7,
			offset: { x: 6, z: -6 },
			tier: 2,
			unlockRequirements: ["defense", "power_sink"],
		},
		{
			index: 8,
			offset: { x: -6, z: -6 },
			tier: 2,
			unlockRequirements: ["archive", "relay"],
		},
	],
	coast_mines: [
		{ index: 0, offset: { x: 0, z: 0 }, tier: 0, unlockRequirements: [] },
		...
		{ index: 2, offset: { x: -6, z: 0 }, tier: 0, unlockRequirements: [] },
		{
			...
			offset: { x: 0, z: 6 },
			tier: 1,
			unlockRequirements: ["transit"],
		},
		{
			index: 4,
			offset: { x: 0, z: -6 },
			tier: 1,
			unlockRequirements: ["storage"],
		},
		{
			index: 5,
			offset: { x: 6, z: 6 },
			tier: 2,
			unlockRequirements: ["fabrication", "power_sink"],
		},
	],
	science_campus: [
		{ index: 0, offset: { x: 0, z: 0 }, tier: 0, unlockRequirements: [] },
		{ index: 1, offset: { x: 6, z: 0 }, tier: 0, unlockRequirements: [] },
		{
			...
			offset: { x: -6, z: 0 },
			tier: 1,
			unlockRequirements: ["archive"],
		},
		{
			index: 3,
			offset: { x: 0, z: 6 },
			tier: 1,
			unlockRequirements: ["research"],
		},
		{
			index: 4,
			offset: { x: 0, z: -6 },
			tier: 2,
			unlockRequirements: ["research", "relay"],
		},
	],
	northern_cult_site: [
		{ index: 0, offset: { x: 0, z: 0 }, tier: 0, unlockRequirements: [] },
	...
	deep_sea_gateway: [
		...
		},
		{
			...
			offset: { x: -6, z: 0 },
			tier: 2,
			unlockRequirements: ["gateway_access", "power_sink"],
		},
	],
};
...
export const CONSTRUCTION_BLUEPRINTS: ConstructionBlueprint[] = [
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 8, eWaste: 2, intactComponents: 1 },
				partIndices: [0, 1, 2, 3],
				buildTicks: 30,
				description: "Erecting corner columns to anchor the substation shell.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 12, eWaste: 4, intactComponents: 2 },
				partIndices: [4, 5, 6, 7],
				buildTicks: 45,
				description:
					"Sealing walls and framing the window run for observation.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 4, eWaste: 8, intactComponents: 4 },
				partIndices: [8, 9],
				buildTicks: 30,
				description: "Installing command console and teleporter relay.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 2, eWaste: 2, intactComponents: 1 },
				partIndices: [10],
				buildTicks: 15,
				description: "Capping with detailed roof and bringing systems online.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 6, eWaste: 1, intactComponents: 0 },
				partIndices: [0, 1],
				buildTicks: 20,
				description: "Raising corridor walls to form the relay spine.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 8, eWaste: 3, intactComponents: 1 },
				partIndices: [2, 3],
				buildTicks: 30,
				description: "Framing door entries for transit access.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 2, eWaste: 6, intactComponents: 3 },
				partIndices: [4],
				buildTicks: 25,
				description: "Installing teleporter column for relay signal.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 2, eWaste: 2, intactComponents: 1 },
				partIndices: [5, 6],
				buildTicks: 15,
				description: "Running pipe detail and capping with piped roof.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 10, eWaste: 1, intactComponents: 0 },
				partIndices: [0, 1, 2, 3],
				buildTicks: 25,
				description: "Raising four-wall enclosure for cargo staging.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [8],
				buildTicks: 20,
				description: "Installing roof plating for weather protection.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 6, eWaste: 2, intactComponents: 2 },
				partIndices: [4, 5],
				buildTicks: 20,
				description: "Stacking containers and long crates for throughput.",
			},
			{
				stage: "operational",
				cost: defaultResourcePool(),
				partIndices: [6, 7],
				buildTicks: 5,
				description: "Mounting wall plates for cargo zone identification.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 8, eWaste: 2, intactComponents: 0 },
				partIndices: [0, 1],
				buildTicks: 20,
				description: "Setting wall partitions for workshop zones.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				partIndices: [2, 3],
				buildTicks: 25,
				description: "Installing compute consoles for fabrication control.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 3, eWaste: 8, intactComponents: 4 },
				partIndices: [4],
				buildTicks: 30,
				description: "Placing teleporter for material relay.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 3, eWaste: 3, intactComponents: 2 },
				partIndices: [5, 6, 7, 8],
				buildTicks: 20,
				description:
					"Running overhead pipes, mounting vent and output indicator, capping with detail roof.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [0, 1],
				buildTicks: 15,
				description: "Erecting grounding columns.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 6, intactComponents: 3 },
				partIndices: [2, 3],
				buildTicks: 25,
				description: "Installing teleporter pads for energy capture.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 2, eWaste: 4, intactComponents: 2 },
				partIndices: [4],
				buildTicks: 20,
				description: "Connecting pipe conduits for storm routing.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 2, eWaste: 2, intactComponents: 1 },
				...
				buildTicks: 15,
				description:
					"Mounting warning triangles, detail plate, and piped roof.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 12, eWaste: 2, intactComponents: 1 },
				partIndices: [3, 4],
				buildTicks: 20,
				description: "Planting heavy accent columns as gate anchors.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 16, eWaste: 4, intactComponents: 2 },
				partIndices: [0, 1, 2],
				buildTicks: 35,
				description: "Raising heavy wall panels and framing the gate door.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Gate interior is open hardpoint space.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				...
				buildTicks: 15,
				description:
					"Mounting warning triangles, hazard marker, and orange vent roof.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 6, eWaste: 2, intactComponents: 0 },
				partIndices: [0, 1],
				buildTicks: 20,
				description: "Framing door walls for bidirectional access.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [6],
				buildTicks: 15,
				description: "Installing piped roof for transit shelter.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				partIndices: [2, 3],
				buildTicks: 20,
				description: "Placing equipment base and vessel staging.",
			},
			{
				stage: "operational",
				cost: defaultResourcePool(),
				partIndices: [4, 5],
				buildTicks: 5,
				description: "Mounting directional arrow signage.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 10, eWaste: 3, intactComponents: 1 },
				partIndices: [0, 1, 2, 3],
				buildTicks: 30,
				description:
					"Enclosing archive space with window walls and access door.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [7],
				buildTicks: 15,
				description: "Capping with plated roof for environmental seal.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 4, eWaste: 10, intactComponents: 6 },
				partIndices: [4, 5],
				buildTicks: 35,
				description:
					"Installing computer console and machine statue for archive ritual.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				partIndices: [6],
				buildTicks: 20,
				description: "Building staircase for vertical archive access.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 8, eWaste: 1, intactComponents: 0 },
				partIndices: [0, 1, 2, 3],
				buildTicks: 25,
				description:
					"Framing wide door walls and side partitions for vehicle bay.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [9],
				buildTicks: 15,
				description: "Installing ventilated roof for exhaust clearance.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 6, eWaste: 4, intactComponents: 2 },
				partIndices: [4, 5, 6],
				buildTicks: 25,
				description: "Placing equipment base and staging containers.",
			},
			{
				stage: "operational",
				cost: defaultResourcePool(),
				partIndices: [7, 8],
				buildTicks: 5,
				description: "Adding directional signage and vent grille.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 8, eWaste: 4, intactComponents: 2 },
				partIndices: [0, 1, 2, 3],
				buildTicks: 20,
				description: "Raising four grounding columns as lightning rod frame.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 6, eWaste: 8, intactComponents: 4 },
				partIndices: [4, 5],
				buildTicks: 30,
				description: "Installing dual teleporter pads for energy capture grid.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 4, eWaste: 6, intactComponents: 3 },
				partIndices: [6, 7],
				buildTicks: 25,
				description: "Running overhead pipe conduit and vertical pipe detail.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				...
				buildTicks: 20,
				description:
					"Mounting vent box, warning triangles, and orange vent roof.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [0, 1, 2, 3],
				buildTicks: 20,
				description: "Framing wide corridor walls with cargo-class doors.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 10, eWaste: 4, intactComponents: 2 },
				partIndices: [10],
				buildTicks: 30,
				description: "Capping with side pipe roof for spine protection.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 4, eWaste: 8, intactComponents: 4 },
				partIndices: [4, 5, 6],
				buildTicks: 25,
				description: "Placing loading platform, crate, and container staging.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				...
				buildTicks: 20,
				description:
					"Installing directional arrows and dot pattern wayfinding.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [0],
				buildTicks: 20,
				description: "Deploying generator core for power relay anchor.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 6, intactComponents: 2 },
				partIndices: [1],
				buildTicks: 20,
				description: "Running cable trunk for distribution reach.",
			},
			{
				stage: "interior",
				cost: { scrapMetal: 2, eWaste: 4, intactComponents: 3 },
				partIndices: [2],
				buildTicks: 15,
				description: "Raising antenna mast for relay signal.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 2, eWaste: 4, intactComponents: 2 },
				partIndices: [3],
				buildTicks: 15,
				description: "Aligning satellite dish for network synchronization.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [0],
				buildTicks: 15,
				description: "Laying pipe crossover frame at junction site.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [1],
				buildTicks: 10,
				description: "Erecting support column for elevated pipe run.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Junction interior is open conduit space.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [2],
				buildTicks: 10,
				description: "Installing barrel buffer for pressure regulation.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 10, eWaste: 2, intactComponents: 1 },
				partIndices: [2, 3],
				buildTicks: 20,
				description: "Anchoring gate complex and perimeter fence.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 6, eWaste: 4, intactComponents: 2 },
				partIndices: [1],
				buildTicks: 25,
				description: "Erecting barricade doorway for access control.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Outpost interior is open firing position.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 8, eWaste: 6, intactComponents: 4 },
				partIndices: [0],
				buildTicks: 30,
				description: "Mounting turret cannon for active defense.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [0],
				buildTicks: 25,
				description: "Laying monorail track segment for transit anchor.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 10, eWaste: 2, intactComponents: 1 },
				partIndices: [1],
				buildTicks: 20,
				description: "Constructing loading platform for cargo staging.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Depot is open staging area.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				partIndices: [2],
				buildTicks: 15,
				description: "Docking cargo craft for transit commissioning.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 2, eWaste: 1, intactComponents: 0 },
				partIndices: [2, 3],
				buildTicks: 10,
				description: "Clearing crater debris and bone fragments.",
			},
			{
				stage: "shell",
				cost: defaultResourcePool(),
				partIndices: [1],
				buildTicks: 5,
				description: "Exposing rock formations around the cache site.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Cache contents are exposed.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 2, intactComponents: 1 },
				partIndices: [0],
				buildTicks: 10,
				description: "Securing lootbox for controlled material recovery.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [0],
				buildTicks: 15,
				description: "Stabilizing crystal deposit for extraction access.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 6, eWaste: 4, intactComponents: 2 },
				partIndices: [1],
				buildTicks: 20,
				description: "Installing generator for powered extraction.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Node interior is raw deposit.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 2, eWaste: 2, intactComponents: 1 },
				partIndices: [2],
				buildTicks: 10,
				description: "Mounting pipe ring for material outflow.",
			},
		],
	...
	},
	{
		...
		stages: [
			{
				stage: "foundation",
				cost: { scrapMetal: 6, eWaste: 2, intactComponents: 1 },
				partIndices: [0],
				buildTicks: 25,
				description: "Shoring up derelict hangar superstructure.",
			},
			{
				stage: "shell",
				cost: defaultResourcePool(),
				partIndices: [1, 2],
				buildTicks: 5,
				description: "Cataloging barrel stores and structural detail.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Hangar interior is prior-mission wreckage.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 4, eWaste: 4, intactComponents: 2 },
				partIndices: [],
				buildTicks: 15,
				description: "Reactivating hangar bay for salvage operations.",
			},
		],
		...
		stages: [
			{
				...
				partIndices: [2],
				buildTicks: 15,
				description: "Containing meteor impact zone at breach perimeter.",
			},
			{
				stage: "shell",
				cost: { scrapMetal: 6, eWaste: 2, intactComponents: 1 },
				...
				buildTicks: 20,
				description:
					"Reinforcing window barricade for hostile zone containment.",
			},
			{
				stage: "interior",
				cost: defaultResourcePool(),
				partIndices: [],
				buildTicks: 0,
				description: "Breach interior is active cult territory.",
			},
			{
				stage: "operational",
				cost: { scrapMetal: 2, eWaste: 2, intactComponents: 1 },
				...
				buildTicks: 10,
				description:
					"Posting hazard signage and establishing containment perimeter.",
			},
		],
...
export function getBlueprintForStructure(
	...
	return (
		CONSTRUCTION_BLUEPRINTS.find((bp) => bp.structureId === structureId) ?? null
	);
}
...
export function getRemainingCost(progress: ConstructionProgress): ResourceCost {
	const blueprint = CONSTRUCTION_BLUEPRINTS[progress.blueprintIndex];
	if (!blueprint) {
		return defaultResourcePool();
	}
	const remainingStages = blueprint.stages.slice(
