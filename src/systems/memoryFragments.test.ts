...
describe("config access", () => {
	test("getAllFragmentDefinitions returns fragments", () => {
...
describe("placing fragments", () => {
	...
	test("placeFragmentsInWorld places multiple from locations", () => {
		const locations = [
			{ x: 5, z: 5 },
			{ x: 15, z: 15 },
			{ x: 25, z: 25 },
...
describe("proximity discovery", () => {
	test("discovers fragments within radius", () => {
	...
	test("does not discover fragments outside radius", () => {
		placeFragment("fragment_001", 10, 10);
	...
	test("does not re-discover already discovered fragments", () => {
		placeFragment("fragment_001", 10, 10);
...
describe("reading fragments", () => {
	test("readFragment returns definition and marks as read", () => {
		placeFragment("fragment_001", 10, 10);
		checkProximity(10, 10);
	...
	test("readFragment returns null for unknown fragment", () => {
		expect(readFragment("nonexistent")).toBeNull();
	});

	test("getReadFragments returns all read fragments", () => {
		placeFragment("fragment_001", 10, 10);
...
describe("progress tracking", () => {
	test("getFragmentProgress tracks counts", () => {
...
describe("reset", () => {
	test("resetMemoryFragments clears all state", () => {
		placeFragment("fragment_001", 10, 10);
		checkProximity(10, 10);
		readFragment("fragment_001");
