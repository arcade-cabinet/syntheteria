...
const backgroundImage: AssetModule = "/assets/ui/background.png";
const logosAtlas: AssetModule = "/assets/ui/logos.png";
const brandMarkImage: AssetModule = "/assets/ui/mark.png";
