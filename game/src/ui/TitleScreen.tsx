/**
 * Main title screen — "SYNTHETERIA" in large text with New Game option.
  ...
  return (
    <button
      ...
      style={{
        ...
        textShadow: disabled ? "none" : hovered ? "0 0 10px rgba(0,255,170,0.5)" : "none",
        boxShadow: primary && hovered ? "0 0 20px rgba(0,255,170,0.2), inset 0 0 20px rgba(0,255,170,0.05)" : "none",
      }}
    >
