...
function iconStroke(props: SvgProps) {
...
export function ExpoIcon(props: SvgProps) {
	return (
		<Svg viewBox="0 0 256 231" {...props}>
			<Path
...
export function DrizzleIcon(props: SvgProps) {
	return (
...
export function TSIcon(props: SvgProps) {
	return (
...
export function DroneIcon(props: SvgProps) {
	return (
...
export function FactoryIcon(props: SvgProps) {
	return (
		<Svg viewBox="0 0 24 24" fill="none" {...props}>
			<Path
...
export function StormIcon(props: SvgProps) {
	return (
		<Svg viewBox="0 0 24 24" fill="none" {...props}>
			<Path
...
export function RadarIcon(props: SvgProps) {
	return (
		<Svg viewBox="0 0 24 24" fill="none" {...props}>
			<Circle
				cx="12"
