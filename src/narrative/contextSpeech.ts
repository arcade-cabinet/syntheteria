/**
 * Context speech — faction-specific ambient/contextual dialogue.
 *
 * Contexts: harvesting, combat, storm, idle, movement, discovery.
 */

import type { ContextSpeechTrigger, SpeechProfileId } from "./speechTypes";
