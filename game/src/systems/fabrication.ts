...
export const RECIPES: Recipe[] = [
  {
    ...
    costs: [{ type: "eWaste", amount: 4 }, { type: "intactComponents", amount: 1 }],
    buildTime: 8,
  },
  {
    name: "Arm Assembly",
  ...
  },
  {
    ...
    outputMaterial: "electronic",
    costs: [{ type: "eWaste", amount: 3 }, { type: "scrapMetal", amount: 2 }],
    buildTime: 7,
  },
  {
    name: "Power Supply",
    ...
    outputMaterial: "electronic",
    costs: [{ type: "eWaste", amount: 5 }, { type: "intactComponents", amount: 1 }],
    buildTime: 10,
  },
]
 ...
 */
export function startFabrication(fabricator: Entity, recipeName: string): boolean {
  // Must be a powered fabrication unit
  if (fabricator.building?.type !== "fabrication_unit") return false
  if (!fabricator.building.powered || !fabricator.building.operational) return false
