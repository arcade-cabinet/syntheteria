...
export function NewGameModal({
	...
	return (
		<View className="absolute inset-0 items-center justify-center bg-[#02050a]/72 px-4">
			<View className="absolute inset-0 bg-[#0b1721]/28" />
			<View className="w-full max-w-[1040px] overflow-hidden rounded-[30px] border border-[#8be6ff]/20 bg-[#06111a]/92 shadow-2xl">
				<View className="border-b border-white/8 bg-[#081723]/96 px-6 py-5">
					<Text className="font-mono text-[11px] uppercase tracking-[0.28em] text-[#8be6ff]">
						New Game Configuration
					</Text>
					<Text className="mt-2 font-mono text-[13px] leading-5 text-white/58">
						Commit the seed, scale, and atmospheric pressures that define this
						world before generation. These choices are persisted to the save
						database and drive deterministic map creation.
					</Text>
				</View>

				<View className="gap-5 px-6 py-6">
					<View className="rounded-[22px] border border-[#8be6ff]/16 bg-[#08131a]/80 px-4 py-4">
						...
						<View className="mt-3 flex-row items-center gap-3">
							...
							<Pressable
								...
								className="rounded-[18px] border border-[#7fe5ff]/24 bg-[#0b1822] px-4 py-3"
							>
					...
					<View className="flex-row gap-5">
						<View className="flex-1 rounded-[22px] border border-white/8 bg-[#08131a]/80 px-4 py-4">
							<Text className="font-mono text-[10px] uppercase tracking-[0.24em] text-[#90ddec]">
								Map Size
							</Text>
