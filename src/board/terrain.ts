/**
 * Terrain cluster math — CPU-side noise for floor type assignment.
 *
 * Ported from the former src/terrain/cluster.ts to keep the board package
 * self-contained. Two noise layers: clusterValue (local biomes) and
 * geographyValue (continent-scale geography).
 */

import { TILE_SIZE_M } from "./grid";
import type { Elevation, FloorType } from "./types";
...
// ---------------------------------------------------------------------------
// Cluster selection — high-frequency local terrain
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Geography selection — low-frequency large-scale ocean/land
// ---------------------------------------------------------------------------
