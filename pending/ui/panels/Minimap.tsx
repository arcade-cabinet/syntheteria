...
export function Minimap() {
	...
	return (
		<div className="absolute bottom-4 md:bottom-6 right-3 md:right-4 pointer-events-auto">
			<div className="w-[140px] md:w-[172px] rounded-[20px] md:rounded-[24px] border border-white/10 bg-[#081017]/90 p-2 md:p-3 shadow-2xl">
				<div className="flex flex-row items-center justify-between">
					...
					<div className="h-8 w-8 flex items-center justify-center rounded-2xl border border-white/8 bg-white/5">
						<RadarIcon width={18} height={18} color="#89d9ff" />
					</div>
				</div>

				<div
					className="mt-3 overflow-hidden rounded-[20px] border border-[#89d9ff]/18 bg-[#04090d] relative"
					style={{ width: size, height: size }}
					aria-label="Minimap showing territory, units, and structures"
				>
					<div className="absolute inset-0 bg-[#0e1820]/70" />

					{/* Grid crosshairs */}
					<div className="absolute top-1/2 left-0 h-[1px] w-full bg-[#89d9ff]/18" />
					<div className="absolute left-1/2 top-0 h-full w-[1px] bg-[#89d9ff]/18" />
						...
						return (
							<div
								...
								style={{
									...
									height: 10,
									borderRadius: 4,
									border: `1px solid ${isPlayer ? "rgba(246, 197, 106, 0.7)" : "rgba(255, 143, 143, 0.5)"}`,
					...
					{/* Legend */}
					<div className="absolute bottom-2 left-2 flex flex-row items-center gap-1.5 rounded-full border border-white/8 bg-black/40 px-2 py-1">
						<MapIcon width={12} height={12} color="#89d9ff" />
						<span className="font-mono text-[9px] uppercase tracking-[0.14em] text-white/55">
							Territory
						</span>
					</div>
				</div>
