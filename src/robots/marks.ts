...
export const MARK_DEFS: Record<BotMark, MarkDef> = {
	reinforced_hull: {
		...
		cost: { steel: 2, iron_ore: 1 },
		minTier: 1,
	},
	extended_range: {
		label: "Extended Range",
		effects: { scanRange: 2 },
		cost: { glass: 2, circuits: 1 },
		minTier: 1,
	},
	swift_treads: {
		label: "Swift Treads",
		effects: { maxMp: 1, mp: 1 },
		cost: { timber: 2, steel: 1 },
		minTier: 2,
	},
	harvester_arm: {
		label: "Harvester Arm",
		effects: {},
		cost: { iron_ore: 2, circuits: 1 },
		minTier: 1,
	},
	shield_emitter: {
		label: "Shield Emitter",
		effects: { defense: 2 },
		cost: { quantum_crystal: 1, glass: 2, steel: 2 },
		minTier: 3,
	},
	power_core: {
		label: "Power Core",
		effects: { maxHp: 5, hp: 5, attack: 2 },
		cost: { fuel: 3, quantum_crystal: 2, steel: 3 },
		minTier: 4,
	},
	quantum_processor: {
		label: "Quantum Processor",
		effects: { scanRange: 3, attack: 1, defense: 1 },
		cost: { glass: 4, quantum_crystal: 3, alloy: 2 },
		minTier: 5,
	},
};
