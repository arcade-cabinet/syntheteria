	...
	return (
		...
		>
			<Canvas camera={{ position: [0, 7, 10], fov: 42 }}>
				...
				<directionalLight position={[8, 16, 10]} intensity={2.1} color={0xffffff} />
				<directionalLight position={[-6, 9, -5]} intensity={1.2} color={0x8be6ff} />
				<mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.02, 0]} receiveShadow>
					<planeGeometry args={[18, 18]} />
					<meshStandardMaterial color={0x4b5c66} roughness={0.9} metalness={0.06} />
				</mesh>
